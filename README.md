# cs-cart-to-magento
=== CS-Cart to Magento 1.x Migration Tool ===
Version: 2.4.1
Developed by: LitExtension

Download: https://litextension.com/shopping-cart-migration/cs-cart-to-magento.html

== Description: CS-Cart to Magento 1.x Migration Tool allows you to migrate your products, orders, customers, passwords and other data from CS-Cart to Magento 1.x Migration automatically.
